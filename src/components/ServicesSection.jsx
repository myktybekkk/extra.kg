  ...
  const services = [
    {
      ...
      result: 'Запуск за 7–10 дней конверсионной посадочной страницы с загрузкой за 1,2 секунды, готовым продающим текстом и кнопкой прямой связи, которая переводит до 12% посетителей сразу в диалог WhatsApp.',
      includes: [
        'Разработка продающей структуры и текстов',
        'Индивидуальный UI/UX дизайн в стиле вашей ниши',
        'Мобильная адаптация 100% под телефоны',
        'Интеграция прямой кнопки WhatsApp & Telegram',
        'Базовая настройка SEO и установка пикселей',
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
                ...
                <div className="lg:col-span-7 flex flex-col justify-between h-full">
                  ...
                  <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                    ...
                    <a
                      href={`https://wa.me/996555000000?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20%D0%98%D0%BD%D1%82%D0%B5%D1%80%D0%B5%D1%81%D1%83%D0%B5%D1%82%20%D1%82%D0%B0%D1%80%D0%B8%D1%84%20${encodeURIComponent(service.title)}`}
                      target="_blank"
