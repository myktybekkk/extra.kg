  ...
  const masters = [
    {
      ...
      image: '/azamat.png',
      stat: '+34% конверсия',
      desc: 'Спроектировал интерфейсы для 47 мобильных сервисов и e-commerce площадок. Сократил путь покупателя от входа на сайт до клика на оплату с 7 шагов до 3, подняв среднюю конверсию клиентских магазинов на 34%.'
    },
    {
      ...
      icon: Code2,
      image: '/bakyt.png',
      stat: '90+ Google Speed',
      desc: 'С 2017 года разработал и ввел в эксплуатацию более 80 веб-проектов. Обеспечивает показатели скорости 90+ в Google PageSpeed, исключая потерю мобильного трафика из-за медленной работы базы данных и верстки.'
    },
    {
      ...
      icon: FileText,
      image: '/dinara.png',
      stat: '65+ проектов B2B',
      desc: 'Написала продающие структуры для 65 компаний в сегментах B2B и услуг. Формирует офферы на основе реальных фактов бизнеса, снимая с предпринимателя задачу самостоятельно готовить тексты и технические описания.'
    }
  ];
