...
export default function WorkflowSection({ onOpenModal }) {
  const timeline = [
    ...
    },
    {
      ...
      desc: 'Создаем эффектный дизайн в темных/светлых тонах с учетом вашей айдентики и удобства для смартфонов.'
    },
    {
      day: 'Дни 9–12',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
            От брифа до первых заявок за <span className="text-gradient">14 рабочих дней</span>
          </h2>
          <p className="text-base text-[#A8B0C0] font-light">
            Каждый этап закреплен календарным графиком в договоре. Финансовая ответственность — 1% за день просрочки.
          </p>
        </div>
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-red-500/10 via-amber-500/10 to-[#1FD1A5]/10 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="text-xs sm:text-sm text-white">
              ...
              В случае если задержка произошла по нашей вине — вы получаете компенсацию 1% от стоимости проекта за каждый день просрочки.
            </div>
          </div>
          <button
            onClick={onOpenModal}
